...
path_setup='/p/home/jyu/coamps-proj/static/coamps-amz/amazon-setupABC2/ocn'; 

hgrd1=read_ohgrd(path_setup,1); hgrd2=read_ohgrd(path_setup,2); 
hgrd3=read_ohgrd(path_setup,3); 
vgrd1=read_ovgrdA(path_setup,1); vgrd2=read_ovgrdA(path_setup,2);
