...
plot((1:length(zr3))./length(zr3),zr3,"Marker","o","LineWidth",1,"Color",[0.5210    0.0860    0.8190])

title(append("max dz = ",num2str(max(diff(zr))),"&"), ...
    append(num2str(max(diff(zr2))),"&",num2str(max(diff(zr3))),...
    "&",num2str(max(-diff(z_prof)))))
